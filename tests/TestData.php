...
//Negative test data where one feild is missing 
 public function TestData2()
    {
      $dataset1=array("fname"=>"","lname"=>"sample", "email"=>"tsample@gmail.com","password"=>"cam56Aw","country"=>"US");
      $dataset2=array("fname"=>"test1", "lname"=>"", "email"=>"tsample1@gmail.com","password"=>"cam516Aw","country"=>"US");
      ...
      $dataset5=array("fname"=>"test3","lname"=>"sample3","email"=>"tsample3@gmail.com","password"=>"","Country"=>"Australia");
      $dataset6=array("fname"=>"test4","lname"=>"sample4","email"=>"tsample4@gmail.com","password"=>"Cgaju&7","Country"=>"");
        return[
 ...
 public function TestData3()
 {
     ...
     $dataset3=array("fname"=>"","lname"=>"","email"=>"tsample2@gmail.com","password"=>"","Country"=>"");
